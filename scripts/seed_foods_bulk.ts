neimport { createClient } from '@supabase/supabase-js'
...
const BULK_FOODS = [
    ...
    { name: 'Pan Integral (tajada)', serving_size_g: 30, calories: 80, protein_g: 3, carbs_g: 15, fats_g: 1 },
    { name: 'Pan Blanco (tajada)', serving_size_g: 30, calories: 79, protein_g: 3, carbs_g: 14, fats_g: 1 },
