 ...
 * de plantillas (`/coach/nutrition-v2/plantillas/editor?template=<id>`; desde el retiro del par
 * viejo, 2026-08-17, el wizard `plantillas/builder` redirige ahi mismo).
 *
