                ...
                {succeeded ? (
                    <div className="mt-6 space-y-4">
                        <div className="flex items-center gap-2 rounded-lg border border-[var(--success-500)]/30 bg-[var(--success-500)]/15 px-3 py-2.5">
                            ...
                            <p className="text-sm text-[var(--success-500)]">Coach creado correctamente. Guarda las credenciales antes de cerrar.</p>
                        </div>
                    ...
                    >
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <div className="col-span-2">
                                <Label className="text-body text-xs">Nombre de marca</Label>
                                <Input
                                    name="brand_name"
                            ...
                            <div>
                                ...
                                {/* Pricing v3: el default es 'free' y las opciones salen de SALE_TIERS;
                                ...
                                <Select name="subscription_tier" defaultValue="free">
                                    ...
                                    <SelectContent className="bg-surface-sunken border-subtle text-strong">
                            ...
                            <div>
                                <Label className="text-body text-xs">Facturación</Label>
                            ...
                            <div className="col-span-2">
                                <Label className="text-body text-xs">Días de prueba</Label>
                                <Input
                                    name="trial_days"
                                    type="number"
                                    min={0}
