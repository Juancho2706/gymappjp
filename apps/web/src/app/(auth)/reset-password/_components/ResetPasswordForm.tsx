...
interface ResetPasswordFormProps {
    /** Slugs del query, leídos en el server component (`page.tsx`) para no depender del cliente. */
    coachSlug: string | null
    teamSlug: string | null
}

export function ResetPasswordForm({ coachSlug, teamSlug }: ResetPasswordFormProps) {
