 ...
 * segmentos `shrink-0` comprimen el nombre a cero y desbordan el chip en 360 px, así
 * que con MÁS de 8 segmentos el chip colapsa a una barra de progreso continua +
 * contador n/N (misma semántica marcadas/derivadas con los dos estilos de relleno).
 * Segmentos discretos SOLO con <=8. Espejo RN en `lib/nutrition-v2-portions.ts`.
 */
