...
export function EnterpriseLoginShell({ children, topSlot }: EnterpriseLoginShellProps) {
    return (
        <div
            data-eva-surface="enterprise"
            className="relative flex min-h-dvh flex-col items-center justify-center gap-6 px-4 py-10 pt-safe pb-safe overflow-hidden"
            style={{
                backgroundColor: 'var(--eva-enterprise-bg, #09090b)',
                color: 'var(--eva-enterprise-fg, #f4f4f5)',
            }}
        >
            {/* Gradient mesh */}
            <div
            ...
            {/* Top slot — e.g. EnterpriseTrustHeader */}
            {topSlot && (
                ...
                <div className="mb-8 flex items-center justify-center gap-3">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-1.5 mt-0.5">
                            <ShieldCheck className="h-3 w-3 text-zinc-600" aria-hidden="true" />
