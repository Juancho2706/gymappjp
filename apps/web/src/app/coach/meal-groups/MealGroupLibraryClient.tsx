...
function itemMacros(item: MealGroupItem) {
  ...
  return calculateFoodItemMacros({
    ...
    // Dos filas legacy usan `u`; el motor trata cualquier unidad no g/ml como count,
    // pero normalizamos explícitamente para que el contrato visible sea `un`.
...
function calculateTotals(items: MealGroupItem[]) {
  return items.reduce(
    (acc, item) => {
