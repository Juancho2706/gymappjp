...
export const ADDON_CONFIG: Record<ModuleKey, AddonConfigEntry> = {
    ...
    nutrition_exchanges: {
        ...
        label: 'Nutrición Pro',
        description:
            'El plan de nutrición a nivel profesional: pautas por porciones e intercambios (el método de los nutricionistas) o planes híbridos que combinan franjas guiadas con libertad de registro, con variantes de día, historial completo, objetivos finos por alumno y notas clínicas privadas y de protocolo. Requiere un plan con nutrición (Pro o superior).',
    },
}
