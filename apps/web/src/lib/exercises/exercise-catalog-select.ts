...
export const EXERCISE_CATALOG_COLUMNS =
    'id, coach_id, org_id, team_id, exercise_type, name, muscle_group, equipment, difficulty, gender_focus, body_part, gif_url, image_url, video_url, thumbnail_url, video_start_time, video_end_time, instructions, secondary_muscles, deleted_at, source, created_at' as const
...
export const EXERCISE_LIST_COLUMNS =
    'id, coach_id, org_id, team_id, exercise_type, name, muscle_group, equipment, difficulty, gender_focus, body_part, gif_url, video_url, thumbnail_url, video_start_time, video_end_time, secondary_muscles, deleted_at, source, created_at' as const
