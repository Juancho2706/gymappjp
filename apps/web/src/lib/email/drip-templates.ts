...
<p style="margin:0 0 24px;font-size:15px;color:#374151;line-height:1.7;">
  Creaste <strong>${brand}</strong> en EVA. Ahora el siguiente paso es simple: agrega tu primer alumno y asígnale una rutina. Eso activa todo el flujo.
</p>

${featureRow('👥', 'Agrega tu primer alumno', 'Ve a "Alumnos" y crea el perfil con su correo y contraseña temporal.')}
${featureRow('💪', 'Asígnale un programa', 'Construye una rutina o usa un programa existente y asígnaselo.')}
...
<p style="margin:8px 0 0;font-size:13px;color:#6b7280;">
  ¿Dudas? Responde este correo y te ayudamos en minutos.
</p>`
...
<h1 style="margin:12px 0 16px;font-size:22px;font-weight:800;color:#111827;line-height:1.3;">
  ${coach}, ¿ya tienes tu primer alumno activo?
</h1>
<p style="margin:0 0 20px;font-size:15px;color:#374151;line-height:1.7;">
  Los coaches que activan su primer alumno en los primeros 3 días tienen <strong>5× más probabilidades</strong> de convertirse en usuarios activos del plan pago. Un alumno activo cambia todo — puedes ver el flujo completo en acción.
</p>
...
${featureRow('🥗', 'Planes de nutrición', 'Asigna macros, calorías y comidas. El alumno ve todo desde su app.')}
${featureRow('📋', 'Check-in semanal', 'El alumno reporta peso, energía, sueño. Tú ves la tendencia en el dashboard.')}
  ...
  <tr>
    <td>
      <p style="margin:0;font-size:13px;color:#92400e;line-height:1.6;">
        <strong>La nutrición viene incluida en todos los planes, también en el gratuito.</strong> Ábrela desde la ficha de tu alumno y arma el primer plan en minutos.
      </p>
    </td>
  </tr>
</table>
...
<p style="margin:0;font-size:12px;color:#9ca3af;line-height:1.6;">
  Puedes cambiar de plan en cualquier momento. Sin compromisos anuales obligatorios.
</p>`
    ...
    return [
        {
            ...
            html: wrapEmailLayout(day1Body, {
                previewText: `Agrega tu primer alumno hoy y activa el flujo completo de coaching.`,
        ...
        },
        {
            key: 'day3_clients',
            day: 3,
            subject: `${coach}, ¿ya tienes tu primer alumno activo?`,
        ...
        },
        {
            key: 'day7_nutrition',
            day: 7,
            subject: `Semana 1 completada — suma nutrición y retención 🥗`,
        ...
        },
        {
            ...
            html: wrapEmailLayout(day14Body, {
                previewText: `Revisa tu plan y expande a más alumnos cuando lo necesites.`,
