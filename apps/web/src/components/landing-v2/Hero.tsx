...
import { IOS_STORE_URL } from '@/lib/app-links';
...
const COPY = {
  es: {
    ...
    brand_auto: '↻ auto',
    store_ios: 'Descargar en el App Store',
    store_kicker: 'ya publicada',
  },
  en: {
    hero_1: 'One platform.',
    ...
    store_kicker: 'live on the store',
  },
} as const;
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: 22 }}>
        ...
        {/*
          App Store (pedido del dueño, 2026-08-17). Deliberadamente DISCRETO y no un badge grande:
          la conversión de esta página es «crear cuenta», y un botón de descarga compitiendo con el
          CTA principal desvía clics pagados hacia una tienda donde no hay alta de coach. Acá suma
          otra cosa — prueba de que la app existe de verdad, que es justo lo que sostiene la sección
          de hechos que reemplazó a los testimonios.
          Solo iOS: la ficha de Play todavía responde 404 (ver ANDROID_STORE_IS_PUBLIC).
        */}
        <div data-reveal style={{ animationDelay: '0.33s', marginTop: 14 }}>
          <a
            href={IOS_STORE_URL}
            target="_blank"
