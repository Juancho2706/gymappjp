// Copiado 1:1 de la web: apps/web/src/app/coach/builder/[clientId]/muscle-colors.ts
// Mismo mapa de color por grupo muscular → borde/badge/miniatura idénticos a la web.
