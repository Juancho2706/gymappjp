  ...
  return (
    ...
    >
      <MotiView
        ...
        // El web DECLARA `exit={reducedMotion ? undefined : { y: -24, opacity: 0 }}` (IntervalTimer.tsx:123)
        // pero NUNCA lo reproduce: su <AnimatePresence> vive DENTRO del componente (IntervalTimer.tsx:119) y
        // el provider lo monta con `&&` (WorkoutTimerProvider.tsx:135-137); al cerrar hace `setActive(null)`
        ...
        // fade 200ms) subiendo el <AnimatePresence> de moti al overlay estable del `TimerProvider`. Bajo
