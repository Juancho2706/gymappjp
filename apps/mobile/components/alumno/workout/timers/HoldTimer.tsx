...
export function HoldTimer({ initialSeconds, label, onClose }: HoldTimerProps) {
  ...
  return (
    ...
    >
      <View style={[styles.card, SHADOWS.dark.lg, done ? styles.cardDone : styles.cardIdle]} accessibilityRole="timer">
...
const styles = StyleSheet.create({
  ...
  cardIdle: { borderColor: TRACK_ON_DARK },
  cardDone: { borderColor: `${EMBER_500}99` },
