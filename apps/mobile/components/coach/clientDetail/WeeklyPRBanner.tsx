...
const styles = StyleSheet.create({
  ...
  kicker: { fontSize: 10, letterSpacing: 1, color: 'rgba(255,255,255,0.9)', fontFamily: 'Inter_700Bold' },
  exercise: { fontSize: 18, color: '#FFFFFF', fontFamily: 'Montserrat_800ExtraBold', letterSpacing: -0.3, marginTop: 2 },
  muscle: { fontSize: 12, color: 'rgba(255,255,255,0.82)', fontFamily: 'Inter_600SemiBold' },
  ...
  nextTxt: { fontSize: 11, color: '#FFFFFF', fontFamily: 'Inter_700Bold' },
  statsRow: { flexDirection: 'row', gap: 8 },
  statBox: { flex: 1, backgroundColor: 'rgba(255,255,255,0.16)', borderRadius: 12, paddingVertical: 9, paddingHorizontal: 10, gap: 2 },
  statVal: { fontSize: 15, color: '#FFFFFF', fontFamily: 'Montserrat_800ExtraBold' },
  statLabel: { fontSize: 9.5, color: 'rgba(255,255,255,0.82)', fontFamily: 'Inter_600SemiBold', textTransform: 'uppercase', letterSpacing: 0.4 },
