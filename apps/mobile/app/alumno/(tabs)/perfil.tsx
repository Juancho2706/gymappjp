...
export default function AlumnoPerfilScreen() {
   ...
   * pantalla (limpia push/caché de nutrición, el rol cacheado y la marca del coach). Sin `ok` NO
   * se cierra sesión: sacar al alumno con la cuenta intacta le escondería el fallo.
   */
