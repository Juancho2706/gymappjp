...
- [ ] FD1a `draft-builder.ts`: BuilderState.variants[] + reducer + assembleDraft + autosave v2 + tests
- [ ] FD1b `portions-state.ts`: claves por variante + tests slots homonimos
- [ ] FD1c `builder/page.tsx`: rehidratacion completa desde detail.plan.dayVariants (reemplaza guard)
