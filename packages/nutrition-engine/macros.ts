 ...
 *
 * PURE: sin Next.js / Supabase / React / RN. Movido VERBATIM desde
 * apps/web/src/lib/nutrition-utils.ts a @eva/nutrition-engine (motor canónico
 * reutilizado por web + mobile). No cambiar cuerpos ni firmas.
 */

/** Local copy of the Supabase `Json` type so the package stays dependency-free. */
export type Json =
  | string
  | number
  | boolean
