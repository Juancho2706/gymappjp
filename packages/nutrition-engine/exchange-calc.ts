 ...
 * Sin IO, sin Next.js, sin Supabase, sin React/RN — apto para builder web/mobile, PDF
 * y app del alumno.
 *
 * Fuente de verdad ÚNICA compartida (web + mobile). Espejo 1:1 del histórico
 * `apps/web/src/services/nutrition-exchanges/exchange-calc.ts` (que puede pasar a
 * re-exportar de aquí para de-duplicar del todo — follow-up del seam).
 */
