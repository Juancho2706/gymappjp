...
export const EXERCISE_CATALOG_COLUMNS =
    'id, coach_id, name, muscle_group, equipment, difficulty, gender_focus, body_part, gif_url, image_url, video_url, instructions, secondary_muscles, source, deleted_at, created_at' as const
