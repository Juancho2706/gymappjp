  ...
  return (
    <div className="min-h-dvh bg-background text-foreground overflow-x-hidden relative">
      ...
      <div className="relative z-10">
        ...
        <main className="py-20 px-6">
          <div className="max-w-3xl mx-auto space-y-12">
            ...
            <div className="space-y-8 bg-card border border-border backdrop-blur-xl rounded-[2rem] p-8 md:p-12 text-muted-foreground">
              ...
              <section className="space-y-4">
                <h2 className="text-2xl font-bold text-foreground">2. Objeto</h2>
                <p className="leading-relaxed text-sm md:text-base">
              ...
              <section className="space-y-4">
                <h2 className="text-2xl font-bold text-foreground">3. Uso de la Plataforma</h2>
                <p className="leading-relaxed text-sm md:text-base">
              ...
              <section className="space-y-4">
                <h2 className="text-2xl font-bold text-foreground">4. Propiedad Intelectual e Industrial</h2>
                <p className="leading-relaxed text-sm md:text-base">
              ...
              <section className="space-y-4">
                <h2 className="text-2xl font-bold text-foreground">5. Exclusión de Garantías y Responsabilidad</h2>
                <p className="leading-relaxed text-sm md:text-base">
              ...
              <section className="space-y-4">
                <h2 className="text-2xl font-bold text-foreground">8. Cancelación y Reembolsos</h2>
                <p className="leading-relaxed text-sm md:text-base">
              ...
              <section className="space-y-4">
                <h2 className="text-2xl font-bold text-foreground">8.1 Gestión de plan</h2>
                <p className="leading-relaxed text-sm md:text-base">
              ...
              <section className="space-y-4">
                <h2 className="text-2xl font-bold text-foreground">9. Límites de Uso por Tier</h2>
                <p className="leading-relaxed text-sm md:text-base">
        ...
        {/* Footer */}
        <footer className="border-t border-border bg-transparent py-12 mt-10">
