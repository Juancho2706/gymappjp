...
import { LayoutTemplate, Users, Apple, Plus, HelpCircle, ArrowLeftRight } from 'lucide-react'
...
export function NutritionHub({
  ...
  return (
    <div className="w-full max-w-[2000px] mx-auto animate-fade-in space-y-8">
      ...
      <Link
        href="/coach/nutrition-plans/swaps"
        className="flex items-center gap-2 rounded-xl border border-border/60 bg-muted/20 px-3 py-2 text-xs font-bold text-muted-foreground hover:bg-muted/50 transition-colors w-fit"
      >
