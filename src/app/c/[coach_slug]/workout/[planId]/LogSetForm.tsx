...
export function LogSetForm({
    ...
    const showRpePrompt = isLogged && existingLog?.rpe == null && rpeLocal == null
    ...
    return (
        ...
        >
            ...
            >
                ...
                {(existingLog?.rpe != null || rpeLocal != null) && (
                    <input type="hidden" name="rpe" value={existingLog?.rpe ?? rpeLocal ?? ''} />
                )}
                ...
                {showRpePrompt && (
                    ...
                    >
                        ...
                        <input
                            ...
                            onPointerUp={(e) =>
                                submitRpeUpdate(Number((e.currentTarget as HTMLInputElement).value))
                            }
                        />
