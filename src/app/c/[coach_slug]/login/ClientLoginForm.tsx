...
export default function ClientLoginForm({ coachSlug, primaryColor }: Props) {
    ...
    return (
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 shadow-2xl">
            <div className="mb-6">
                <h2 className="text-xl font-semibold text-zinc-100">Accede a tu entrenamiento</h2>
            ...
            <form action={formAction} className="space-y-5">
                ...
                <div className="space-y-2">
                    <Label htmlFor="client-email" className="text-zinc-300 text-sm font-medium">
                        Email
                    </Label>
                    <div className="relative">
                        ...
                        <Input
                            ...
                            required
                            className={cn(
                                'pl-10 h-12 bg-zinc-800 border-zinc-700 text-zinc-100 rounded-xl',
                ...
                <div className="space-y-2">
                    <Label htmlFor="client-password" className="text-zinc-300 text-sm font-medium">
                        Contraseña
                    </Label>
                    <div className="relative">
