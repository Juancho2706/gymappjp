  ...
  return (
    <>
      <button
        ...
        className={cn(
          "flex items-center gap-1 md:gap-3 px-2 py-2 md:py-3 rounded-2xl text-[10px] md:text-sm font-medium transition-all duration-300 group flex-1 md:flex-none text-primary bg-primary/10 hover:bg-primary/20",
        ...
        <DialogContent className="max-w-md bg-card border-border rounded-3xl">
          ...
          <div className="py-4 flex flex-col items-center text-center">
            ...
            {!isIOS && deferredPrompt && (
              <button
                onClick={handleInstallClick}
                className="w-full bg-primary text-primary-foreground hover:opacity-90 font-bold py-3 px-4 rounded-xl transition-all shadow-lg shadow-primary/20"
              >
                Instalar ahora
              </button>
            )}
