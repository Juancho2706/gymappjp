        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute right-4 top-[max(0.75rem,calc(env(safe-area-inset-top,0px)+0.25rem))] z-20 h-8 w-8 rounded-full border border-white/10 bg-white/5 hover:bg-white/10 hover:text-white"
                size="icon-sm"
              />
            }
          >
