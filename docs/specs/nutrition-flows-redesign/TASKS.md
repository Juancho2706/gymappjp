...
- [~] Cierre O1 (2026-08-06/07):
  ...
  - [ ] Curl al cron con CRON_SECRET (el secret no esta en env local — lo corre el owner o proxima sesion con el secret)
  - [ ] QA device fisico Android (RN con datos) — requiere APK dev ARM (eas build --local) o Metro+USB
