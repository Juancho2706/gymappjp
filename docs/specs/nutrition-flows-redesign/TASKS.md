...
- [x] T2.5 Swipe ⇄ + sheet 2 bloques (autorizados / grupo) — **QA CERRADO 2026-08-10 web + device** (detalle y actas en [`nutrition-exchange-swap/`](../nutrition-exchange-swap/TASKS.md)). Codigo en `rnmobiledenuevo` (preview), 2 migraciones en LIVE (`20260810161604`, `20260810171529`); cierra el reparo offline de T2.4 (chip "En cola" verificado con modo avion en device). Extra: fix de UI optimista del Hoy web (`5139b29e`). **Pendiente decision owner: merge a master + OTA android**; abiertas H1 (buscador vs parentesis) y D5 (pista de descubrimiento del swipe)
