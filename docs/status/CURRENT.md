...
**Apple aprobó 1.1.3 el 16-09 (pública 14:04Z). Queda: Beta Review del grupo EXT, SKAN cuando Meta habilite «Configurar eventos», confirmar si el socio vio la hoja ATT en inglés (⇒ `locales`, build nueva).**
