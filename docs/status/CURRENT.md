...
0. **F2 «Descanso siempre» EN PRODUCCIÓN 11-09 22:57Z, QA del owner VERDE ⇒ `done`** (con el mismo verde cierran arreglos-chicos, share-bloque y plan-vivo; [SPEC §20](../specs/cuenta-atras-en-pantalla/SPEC.md)). **«Despegue rápido» EN PRODUCCIÓN 11-09 23:48Z** (deploy `dpl_H2B91dcR…` READY, OTA 1.1.2 android `a349abee` / ios `d7b9a9d5`, E2E 9/9; [SDD](../specs/despegue-rapido/SPEC.md); Sentry `EVA-NEXTJS-1P/1Q` + `EVA-MOBILE-F`, causa = waterfall de carga del ejecutor): RN pinta desde caché antes de esperar auth, web emite la señal sin marca de morph, TTL 20 s, telemetría honesta. Sin migraciones. **Queda: QA del owner (5 puntos del SPEC) y Sentry a 72 h (~14-09).**
