...
0. **Tren «Reps tras el reloj» (fuerza por tiempo) — EN PRODUCCIÓN 12-09 21:27Z: `master` = `rnmobiledenuevo` = `055269f2` (commits en [TEST_STATUS](../testing/TEST_STATUS.md)), deploy `dpl_8jx73Xxz…` READY, OTA 1.1.2 android `01a09783-5424…` / ios `01a09783-2049…`, E2E `prod-suave` 9/9 (run 34719982237)** ([SDD](../specs/reps-tras-el-reloj/SPEC.md) · [tareas](../specs/reps-tras-el-reloj/TASKS.md); mockup aprobado artifact `6ead4180` v3): a 0 la serie se guarda sola (V2), RN suena como el descanso, y en las dos plataformas se abre solo el teclado/sheet si faltan reps (o kg); línea «Serie N · Editar · Repetir»; «Repetir» rearma el reloj. Cero migraciones. Gates completos verdes 12-09 ([TEST_STATUS](../testing/TEST_STATUS.md)). **Queda: QA del owner en device y web (10 puntos del SPEC §10; incluye el arrastre del share) ⇒ SDD `done`.**
