...
**Queda: aprobación de Apple (build 61 en App Review + Beta Review del grupo EXT), SKAN cuando Meta habilite «Configurar eventos», confirmar si el socio vio la hoja ATT en inglés (⇒ `locales`, build nueva).**
