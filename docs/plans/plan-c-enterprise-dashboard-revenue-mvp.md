...
- [x] Crear guard central para no mezclar `coach_standalone`, `enterprise_coach`, `enterprise_staff`, `student_standalone`, `student_enterprise`. Completado el 2026-05-24 16:00:21 -04:00. Actualizado el 2026-05-24 18:24:45 -04:00. Archivo: `apps/web/src/services/auth/workspace-route-guard.service.ts`. Matriz conectada parcialmente al middleware para `/coach/*`: usuarios multi-workspace sin preferencia van a selector; `enterprise_coach` no puede entrar a billing/settings de coach standalone.
